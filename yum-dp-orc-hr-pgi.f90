...
!                              5th release(orc) 2017/10/10, by hyokota
!                              4th release(dp) 2017/07/07, by hyokota
!                              3rd release(f90) 2017/05/31, by hyokota
!                              2nd release(opt) 2003/02/10 by hyokota
!                              1st release 1995/11/09 by hyokota
! **********************************************************************
...
SUBROUTINE orc(it, iout)
  ...
  DO i=1,ix
     ...
     IF ( cl<0.0d0 .OR. ieee_is_nan(cl) ) THEN      ! μ = 0
        u(i,jy,1) = u(i,jy,-1)
        !        clun(i:i)='0'
